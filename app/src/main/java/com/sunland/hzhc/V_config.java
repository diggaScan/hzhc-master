...
public class V_config {
    ...
    public final static String MODEL = Build.MODEL;//手机型号
    public final static String OS = "android" + Build.VERSION.RELEASE;//手机操作系统
    ...
    //
    public static String DLMK = "1";

    public static String ssjBbh = "02";
