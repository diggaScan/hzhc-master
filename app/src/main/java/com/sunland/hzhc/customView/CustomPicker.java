package com.sunland.hzhc.customView;
...
public class CustomPicker {
    ...
    private void initTimePicker() {
        ...
        for (int i = 0; i <= 23; i++) {
            range_set1[i] = String.format("%s", i);
        }
        ...
        for (int i = 0; i <= 59; i++) {
            range_set2[i] = String.format("%s", i);
        }
    ...
    private void initDatePicker() {
        ...
        year_picker = (NumberPicker) mView.findViewById(R.id.datePicker1);
        ...
        day_picker = (NumberPicker) mView.findViewById(R.id.datePicker3);
